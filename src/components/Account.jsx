  ...
  return (
    <main>
      <div className="relative w-full h-[100vh] flex items-center justify-center text-center">
        ...
        {toggle ? (
          <div className="relative bg-white rounded-3xl m-2 p-10 py-5 max-md:p-6 w-full max-w-[32rem] shadow-md z-50 text-center">
            {/* Exit icon */}
            <Link to="/">
            ...
            {type == "Dealer" ? (
              <div className="w-full flex gap-4 mb-3">
                ...
                <div className="w-1/2">
                  ...
                  <div className="border rounded h-[35px] bg-gray-50">
                    <Upload className="w-full  ">
                      <Button
                        className="w-full h-[25px] my-[5px]"
                        icon={<UploadOutlined />}
                      >
                        Choose File
                      </Button>
          ...
          <div className="w-full justify-center items-center flex">
            {loginOtp ? (
              <div className="relative bg-white rounded-3xl m-2 p-20 py-8 max-md:p-6 w-full max-w-[26rem] shadow-md z-50 text-center">
                {/* Exit icon */}
                <Link to="/">
                  <div className="absolute top-5 right-5 text-xs font-medium flex items-center gap-1 cursor-pointer">
                    EXIT{" "}
              ...
              <div className="relative bg-white rounded-3xl m-2 p-10 py-8 max-md:p-6 w-full max-w-[32rem] shadow-md z-50 text-center">
                {/* Exit icon */}
                <Link to="/">
                  <div className="absolute top-5 right-5 text-xs font-medium flex items-center gap-1 cursor-pointer">
                    EXIT{" "}
